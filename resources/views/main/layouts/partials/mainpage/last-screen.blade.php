      ...
      <div class="w-full sm:w-1/2 p-6 mt-6">
        <div class="align-middle">
          ...
          <ul class="list-disc text-lg font-bold text-gray-600 mt-4 ml-8">
            <li class="my-1"><a class="hover:underline" href="#">более 10 лет опыта</a></li>
            <li class="my-1"><a class="hover:underline" href="#">сертифицированные специалисты</a></li>
            <li class="my-1"><a class="hover:underline" href="#">высокое качество и быстрые темпы работ</a></li>
            <li class="my-1"><a class="hover:underline" href="#">гарантии и ответственность за предоставляемые услуги</a></li>
          </ul>
          <div class="flex items-center justify-center">

            <phone-btn title="Получить консультацию"></phone-btn>
