      ...
      <div class="w-full sm:w-1/2 p-6 mt-6">
        <div class="align-middle">
          ...
          <ul class="list-disc text-lg font-bold text-gray-600 mt-4 ml-8">
            <li class="my-1">более 10 лет опыта</li>
            <li class="my-1">сертифицированные специалисты</li>
            <li class="my-1">высокое качество и быстрые темпы работ</li>
            <li class="my-1">гарантии и ответственность за предоставляемые услуги</li>
          </ul>
          <div class="flex items-center justify-center">

            <phone-btn title="Получить консультацию" color="gradient text-white"></phone-btn>
